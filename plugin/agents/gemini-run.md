...
- MODEL : si le header fournit un MODEL non vide, résous-le via la table d'alias ci-dessous (une valeur absente de la table est passée telle quelle, supposée être un label exact) ; sinon `gemini-3.6-flash-high`.
